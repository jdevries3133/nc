        ...
        let prop_buttons =
            self.props.iter().fold(String::new(), |mut acc, p| {
                ...
                let type_string = match p.type_id {
                    models::ValueType::Int => "integer",
                    models::ValueType::Bool => "checkbox",
                    models::ValueType::Float => "percent",
                    models::ValueType::Date => "date",
                };
                acc.push_str(&format!(
                    r#"
                <button
...
pub struct NewFilterTypeOptions<'a> {
    ...
    pub prop_id: i32,
    pub prop_type: &'a models::ValueType,
}
