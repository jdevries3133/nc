...
-- collection = a set of pages
-- collection has a set of page props
-- page has a set of prop values
-- page's prop values should be in sync w/ its collections
-- page has content (we'll just have markdown for now)
--
-- j
